...
dtGDP <- read_excel('~/The-Little-R-Workshop-A-Primer/Examples/10_RMD_EconIndicators_Flexdashboard/fredgraph.xls',sheet = 'GDP')

#Read US Unemployment Rate and ISM PCI Index Data Set from FED Excel File 
dtOtherIndicators <- read_excel('~/The-Little-R-Workshop-A-Primer/Examples/10_RMD_EconIndicators_Flexdashboard/fredgraph.xls',sheet = 'Sheet2')
