...
dtGDP <- read_excel('~/Foundation-of-the-R-Workflow-workshop-2017-10-08/10_RMD_EconIndicators_Flexdashboard/fredgraph.xls',sheet = 'GDP')

#Read US Unemployment Rate and ISM PCI Index Data Set from FED Excel File 
dtOtherIndicators <- read_excel('~/Foundation-of-the-R-Workflow-workshop-2017-10-08/10_RMD_EconIndicators_Flexdashboard/fredgraph.xls',sheet = 'Sheet2')
